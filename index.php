<!DOCTYPE html>
<html lang="en">
	<!-- head tag is stated into thr file head.php(partials/header.php) -->
	<!-- connection is stablished under header section  
	i.e. connect.php file is stated under header.php -->
	<?php
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			?>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php $final ['category_id'] ?>">
					<!-- Block2 -->
					<div class="block2">
